      ...
      duration: 0.8
          ...
          ease: "easeOut"
              ...
              <div className="relative w-72 h-48 md:w-[420px] md:h-72">
                ...
                <div className="absolute inset-0 rounded-md opacity-[0.08] pointer-events-none mix-blend-multiply" style={{
              backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noiseFilter'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.9' numOctaves='4' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noiseFilter)'/%3E%3C/svg%3E")`
                ...
                <div className="absolute bottom-0 left-0 right-0 h-[60%] bg-gradient-to-t from-ivory via-ivory to-blush/20 rounded-b-md">
                  {/* Decorative lines */}
                  <div className="absolute bottom-10 left-6 right-6 h-px bg-gold/20" />
              ...
              height: '50%'
                ...
                clipPath: 'polygon(0 0, 100% 0, 50% 100%)'
                  ...
                  {/* Flap edge line */}
                  <div className="absolute w-full h-full opacity-40" style={{
