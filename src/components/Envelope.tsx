                ...
                <div className="absolute top-[42%] left-1/2 -translate-x-1/2 -translate-y-1/2 z-20">
                  ...
                  >
                    ...
                    <div className="relative w-16 h-16 md:w-24 md:h-24 rounded-full bg-gradient-to-br from-rose-light via-rose to-rose-dark shadow-2xl flex items-center justify-center">
                      {/* Seal inner shadow */}
                      <div className="absolute inset-0 rounded-full shadow-inner" style={{ boxShadow: 'inset 0 2px 8px hsl(var(--rose-dark) / 0.4)' }} />
                      {/* Seal texture rings */}
                    ...
                    <div className="absolute -bottom-1 left-3 w-2 h-3 md:w-2.5 md:h-4 bg-gradient-to-b from-rose to-rose-dark rounded-full" />
                    ...
                    <div className="absolute -bottom-0.5 right-5 w-1 h-1.5 md:w-1.5 md:h-2 bg-gradient-to-b from-rose to-rose-dark rounded-full" />
                  </motion.div>
                </div>
              </div>
            </motion.div>
