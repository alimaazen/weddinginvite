      ...
      duration: 0.8
          ...
          ease: "easeOut"
              ...
              <div className="relative w-72 h-44 md:w-96 md:h-56">
                ...
                <div className="absolute -top-1 left-0 right-0 overflow-visible" style={{ height: '55%' }}>
                ...
                <div className="absolute top-[48%] left-1/2 -translate-x-1/2 -translate-y-1/2 z-20">
                  ...
                  >
                    ...
                    <div className="relative w-14 h-14 md:w-20 md:h-20 rounded-full bg-gradient-to-br from-rose-light via-rose to-rose-dark shadow-lg flex items-center justify-center">
                      ...
                      {/* Heart icon */}
                      <svg className="w-5 h-5 md:w-7 md:h-7 text-ivory drop-shadow-sm" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
                      </svg>
                    </div>
                    
                    {/* Tiny wax drips */}
                    <div className="absolute -bottom-1 left-3 w-1.5 h-2 md:w-2 md:h-3 bg-gradient-to-b from-rose to-rose-dark rounded-full" />
